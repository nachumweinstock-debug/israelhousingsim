...
const en = {
  ...
  wizard: {
    ...
    eyebrowAge: "One more about you",
    qAge: "What's the age of the older borrower?",
    qAgeSub:
      "For a joint application, use the older of the two. This sets your maximum loan term under the age 80 payoff rule.",
    ageUnit: "years old",
  ...
  export: {
    ...
    printHebrew: "Download in Hebrew",
    printEnglish: "Download in English",
    printBoth: "Download in both",
  ...
  printDoc: {
    ...
    generated: "Generated {date} · VryfID Mortgage Readiness Check",
...
const he: Strings = {
  ...
  wizard: {
    ...
    eyebrowAge: "עוד פרט עליכם",
    qAge: "מה גיל הלווה המבוגר יותר?",
    qAgeSub: "בבקשה משותפת, השתמשו בגיל המבוגר מבין השניים. זה קובע את תקופת ההלוואה המרבית לפי כלל פירעון עד גיל 80.",
    ageUnit: "שנים",
  ...
  export: {
    ...
    printHebrew: "הורדה בעברית",
    printEnglish: "הורדה באנגלית",
    printBoth: "הורדה בשתי השפות",
  ...
  printDoc: {
    ...
    generated: "הופק {date} · בדיקת מוכנות למשכנתא של VryfID",
