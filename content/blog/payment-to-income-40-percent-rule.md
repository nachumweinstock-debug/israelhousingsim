...
LTV tells a bank how much of the property it's exposed to. Payment-to-income (sometimes called PTI, or referred to as your hachzarnu ratio) tells the bank something different and arguably more important day to day: whether you can actually afford the monthly payment without straining your finances every month for the next two or three decades.
...
The [VryfID simulator](/simulator/welcome) calculates your payment-to-income automatically as you build your loan mix, and flags it clearly against the 40% comfort line, so you know where you stand before it becomes a negotiating point in a bank meeting.
