...
Once you know what prime, kalatz, and katz tracks actually do (if you haven't yet, [start there](/blog/prime-kalatz-katz-tracks-explained)), the harder question is how to split your loan across them. There's no universal right answer, but there is a useful way to think about it.
...
Buyers who most want to know exactly what they'll pay every month, for budgeting or peace of mind, typically lean more heavily into kalatz (fixed, not inflation-linked). It's the closest thing to a flat, fully predictable payment available in the Israeli system. The cost is a higher starting rate than prime, and no ability to benefit if rates drop.
...
Don't just look at today's blended payment. Ask your bank, or model it yourself, for two additional numbers: your payment if Prime rises by 1-2 points, and your projected payment on your katz/kalatz-linked portions a decade out, once realistic CPI compounding is applied. A mix that looks affordable today but becomes uncomfortable under either of those scenarios is telling you something important before you sign, not after.
